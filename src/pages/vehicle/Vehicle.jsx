    ...
    <div>
      <div className="p-4 bg-white ">
        <header className="align-middle flex items-center">
          ...
          {vehicle.active ? (
            <div className="text-sm font-bold py-1 px-2 mx-4 rounded text-white bg-green-500">
              ACTIVE
            </div>
          ) : (
            <div className="text-sm font-bold py-1 px-2 mx-4 rounded text-white bg-red-500">
              INACTIVE
            </div>
          )}
        </header>
        <div className='my-2 text-zinc-500'>
          ACTIVATION DATE: {vehicle.activation_date}
        </div>
